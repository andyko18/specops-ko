...
> **작성**: 2026-06-13 · 격차 분석 기반 (vs Superpowers v5.1.0 측정 철학 · promptfoo LLM-eval)
...
|---|---|---|---|---|---|
| **V1** | 거버넌스 강제력 승격 | W-2 | 없음 | ★★★ | 불필요 |
| **V2** | 간이 뮤테이션 하니스 | W-1(부분) | 없음 | ★★★ | 불필요 |
| **V3** | integration/perf 게이트 강화 | W-3, W-4 | 없음 | ★★ | 불필요 |
| **V4** | 멀티모델 critic 실체화 | W-5 | CLI 설치 | ★★ | 불필요(외부 CLI) |
| **V5** | llm-eval 공통 매트릭스 러너 | W-6 | 없음 | ★ | 불필요 |

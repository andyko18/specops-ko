...
**Claude Code 전용 한국어 자율 Lifecycle 플러그인** (v1.102.0)
...
├── templates/          ← 36건 (lifecycle 20 + /init-project 산출 14 + 기타)
...
*초기화: 2026-04-21 · v1.0.0 릴리즈: 2026-04-26 · **최신: v1.102.0 (2026-09-15)** · Claude Code 전용*
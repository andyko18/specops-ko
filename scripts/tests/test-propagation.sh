...
expected="ac-format-switch,active-fid-producer,assumption-digest-deterministic,batch-gate-propagation,batch-id-active-resume,batch-queue-init,batch-review-skip,decisions-ledger-resolved,declared-testcmd-anchor,design-critical-cap,doctor-readonly-always-zero,end-loaded-skip,foundation-before-batch,foundation-fr-boundary,foundation-if-baseline,foundation-manifest-gate,foundation-merged-before-batch,foundation-shell-baseline,friction-aggregate-default,gbrain-confidence-example,lite-bc-mandatory,lite-clarify-plan-skip,lite-screen-if-keep,lite-strict-guard,p2t-generator-wiring,p2t-must-ac-gate,predispatch-check-wiring,r1-docs-only-scope,receipt-mandatory,reconcile-review-skip,regression-ac-gate,release-ready-hard,review-audit-structured,review-presence-warn,review-verdict-contract,tdd-red-observation,template-example-detectable,uiux-asset-adapter"

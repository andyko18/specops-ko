...
expected="ac-format-switch,active-fid-producer,assumption-digest-deterministic,batch-gate-propagation,batch-id-active-resume,batch-queue-init,batch-review-skip,bounded-run-watchdog,decisions-ledger-resolved,declared-testcmd-anchor,design-critical-cap,doctor-readonly-always-zero,end-loaded-skip,file-class-sot,foundation-before-batch,foundation-entry-if-scope,foundation-fr-boundary,foundation-if-baseline,foundation-manifest-gate,foundation-merged-before-batch,foundation-shell-baseline,friction-aggregate-default,friction-scope-class,gbrain-confidence-example,intent-per-fid-gate,lite-bc-mandatory,lite-clarify-plan-skip,lite-screen-if-keep,lite-strict-guard,matrix-pattern-lint,p2t-generator-wiring,p2t-must-ac-gate,predispatch-check-wiring,process-design-rename,propagation-env-pin,r1-docs-only-scope,receipt-mandatory,reconcile-review-skip,regression-ac-gate,release-push-recursion-guard,release-ready-hard,review-audit-structured,review-presence-warn,review-return-summary,review-verdict-contract,runner-anchor-exec-evidence,runner-whitelist-prefix,screens-overview-consumption,skip-citation-sot,start-entry-design-first,tdd-red-observation,template-example-detectable,trigger-prefix-value-space,uiux-asset-adapter"

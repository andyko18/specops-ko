...
expected="batch-id-active-resume,batch-review-skip,design-critical-cap,end-loaded-skip,lite-bc-mandatory,lite-clarify-plan-skip,lite-screen-if-keep,lite-strict-guard,receipt-mandatory,reconcile-review-skip,release-ready-hard,review-audit-structured,review-verdict-contract"
